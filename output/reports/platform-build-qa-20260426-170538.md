...
- Generated: 2026-04-26T17:05:38.9044640Z
- Unity: 6000.4.1f1
- Git: main @ 046fb78
...
| editmode-tests | Unity Test Runner | Passed | `` | Run EditMode tests with `Unity -batchmode -projectPath <repo> -runTests -testPlatform editmode -testResults output/reports/m24-editmode-results.xml`. | OK |
| playmode-smoke-tests | Unity Test Runner | Passed | `` | Run PlayMode smoke tests with `Unity -batchmode -projectPath <repo> -runTests -testPlatform playmode -testResults output/reports/m24-playmode-results.xml`. | OK |
