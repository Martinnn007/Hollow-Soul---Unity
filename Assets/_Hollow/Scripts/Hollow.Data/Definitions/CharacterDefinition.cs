...
namespace Hollow.Data.Definitions
{
    ...
    public sealed class CharacterDefinition : ScriptableObject
    {
        ...
        [SerializeField] private string starterRangedWeaponId = "starter_bolt";
            ...
            IEnumerable<BuildTag> nextTags = null)
        {
            ...
            starterRangedWeaponId = string.IsNullOrWhiteSpace(nextStarterRangedWeaponId) ? "starter_bolt" : nextStarterRangedWeaponId;
