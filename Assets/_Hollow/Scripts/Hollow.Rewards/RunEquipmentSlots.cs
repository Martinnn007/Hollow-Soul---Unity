...
namespace Hollow.Rewards
{
    public sealed class RunEquipmentSlots
    {
        ...
        public string RangedWeaponId { get; private set; } = WeaponIdAliases.StarterPistolId;
        ...
        public string ShieldId { get; private set; } = ShieldDefinition.StarterShieldId;
        ...
        public void EquipRangedWeapon(string weaponId)
        {
            ...
            RangedWeaponId = string.IsNullOrWhiteSpace(normalizedWeaponId) ? WeaponIdAliases.StarterPistolId : normalizedWeaponId;
        }
        ...
        public void EquipShield(string shieldId)
        {
            ShieldId = string.IsNullOrWhiteSpace(shieldId) ? ShieldDefinition.StarterShieldId : shieldId;
        }
        ...
        public static RunEquipmentSlots FromSaveState(RunEquipmentSlotsSaveState saveState)
        {
            ...
            slots.EquipShield(saveState.shieldId);
            return slots;
        }
    }
}
