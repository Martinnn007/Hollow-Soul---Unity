...
namespace Hollow.Combat
{
    public sealed class EnemyCatalog : ScriptableObject
    {
        ...
        public static EnemyCatalog CreateRuntimeDefault()
        {
            ...
            charger.Configure("spawnEnemyCharger", "Ash Charger", EnemyArchetypeId.Fast, EnemyBehaviorId.Charger, EnemyMovementMode.Grounded, 4, 1.2f, 1, 1f, 0.34f, 5.5f, 1.2f, 1, 5f, 5.5f, 2f, "spawnEnemyNormal", 0, new Color(1f, 0.34f, 0.12f, 1f));
            ...
            turret.Configure("spawnEnemyTurret", "Bone Turret", EnemyArchetypeId.Heavy, EnemyBehaviorId.TurretShooter, EnemyMovementMode.Grounded, 4, 0f, 1, 1f, 0.34f, 8f, 1.35f, 1, 4.8f, 0f, 2f, "spawnEnemyNormal", 0, new Color(0.72f, 0.86f, 0.94f, 1f));
            ...
            splitter.Configure("spawnEnemySplitter", "Husk Splitter", EnemyArchetypeId.Normal, EnemyBehaviorId.Splitter, EnemyMovementMode.Grounded, 5, 1.1f, 1, 1f, 0.36f, 4f, 1.4f, 1, 4f, 4f, 2f, "spawnEnemyNormal", 2, new Color(0.55f, 0.95f, 0.35f, 1f));
