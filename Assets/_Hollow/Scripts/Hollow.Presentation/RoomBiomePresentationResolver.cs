...
namespace Hollow.Presentation
{
    public static class RoomBiomePresentationResolver
    {
        ...
        private static readonly MaterialRole[] PrewarmMaterialRoles =
        {
            ...
            MaterialRole.EnemyNormal,
            MaterialRole.EnemyFlying,
            MaterialRole.EnemyFast,
            MaterialRole.EnemyHeavy,
            MaterialRole.EnemyCharger,
            MaterialRole.EnemyTurret,
            MaterialRole.EnemySplitter,
            MaterialRole.EnemySpittingPod,
            MaterialRole.EnemyRat,
            MaterialRole.EnemySpider,
            MaterialRole.EnemyHollowBird,
            MaterialRole.EnemyHollowBeast,
            MaterialRole.EnemySkeletonSword,
            MaterialRole.EnemySkeletonSpear,
            MaterialRole.EnemyKnight,
            MaterialRole.EnemyGiant,
            MaterialRole.EnemyHollowArcher,
            MaterialRole.EnemyPowderGunner,
            MaterialRole.EnemyKnifeThrower,
            MaterialRole.EnemyRepeaterTurret,
            MaterialRole.EnemyClockworkSentry,
            MaterialRole.EnemyHollowAcolyte,
            MaterialRole.EnemyWraith,
            MaterialRole.EnemySoulEater,
            MaterialRole.EnemyCurseBinder,
            MaterialRole.EnemyGraveLantern,
            MaterialRole.EnemyStarforgedOctantSentry,
            MaterialRole.EnemyCrimsonRailSpider,
            MaterialRole.EnemyAzureMinigunTurret,
            MaterialRole.EnemyBoss,
            MaterialRole.EnemyProjectile,
            MaterialRole.ShieldGuard,
            MaterialRole.CombatTelegraphSafe,
