        ...
        private static IReadOnlyList<ChallengeDefinition> GenerateChallenges()
        {
            return new[]
            {
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "iron_cleaver", rangedWeaponId: "starter_bolt", consumableCardId: "ember_card"),
                    8,
                    0,
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "iron_cleaver", rangedWeaponId: "starter_bolt", armorId: "dragon_scale_armor", activeItemId: "mending_charm"),
                    6,
                    0,
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "dragon_fang", rangedWeaponId: "starter_bolt", activeItemId: "echo_burst"),
                    6,
                    0,
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "starter_blade", rangedWeaponId: "starter_bolt", activeItemId: "mending_charm", consumableCardId: "mend_card"),
                    2,
                    22,
                    Array.Empty<ChallengeRuleDefinition>(),
