        ...
        private static IReadOnlyList<ChallengeDefinition> GenerateChallenges()
        {
            return new[]
            {
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "iron_cleaver", rangedWeaponId: "starter_bow", consumableCardId: "ember_card"),
                    8,
                    0,
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "iron_cleaver", rangedWeaponId: "starter_bow", armorId: "dragon_scale_armor", activeItemId: "mending_charm"),
                    6,
                    0,
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "starter_blade", rangedWeaponId: "bone_bow", consumableCardId: "swift_card"),
                    10,
                    0,
                    Array.Empty<ChallengeRuleDefinition>(),
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "dragon_fang", rangedWeaponId: "starter_bow", activeItemId: "echo_burst"),
                    6,
                    0,
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "starter_blade", rangedWeaponId: "starter_bow", activeItemId: "mending_charm", consumableCardId: "mend_card"),
                    2,
                    22,
                    Array.Empty<ChallengeRuleDefinition>(),
                ...
                SaveChallenge(
                    ...
                    ChallengeRunLoadout.Create(meleeWeaponId: "starter_blade", rangedWeaponId: "starter_bow", consumableCardId: "swift_card"),
                    8,
                    0,
