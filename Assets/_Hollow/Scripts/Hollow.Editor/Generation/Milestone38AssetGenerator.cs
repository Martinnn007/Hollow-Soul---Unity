...
namespace Hollow.Editor.Generation
{
    public static class Milestone38AssetGenerator
    {
        ...
        private static IEnumerable<TargetSpec> BuildTargets()
        {
            ...
            yield return Target("enemy_starforged_octant_sentry", "Enemy Starforged Octant Sentry", "Enemies", PresentationPrefabRole.EnemyStarforgedOctantSentry, ArtPassAssetTargetPriority.High, true, "Static Meshy machine sentry with eight-direction shot identity and amber emission read.", Scale("0.92m wide", "0.86m tall"));
            yield return Target("enemy_crimson_rail_spider", "Enemy Crimson Rail Spider", "Enemies", PresentationPrefabRole.EnemyCrimsonRailSpider, ArtPassAssetTargetPriority.High, true, "Mobile spider-like railgun mech with clear rifle/muzzle and crimson emission read.", Scale("0.9m wide", "0.72m tall"));
            yield return Target("enemy_azure_minigun_turret", "Enemy Azure Minigun Turret", "Enemies", PresentationPrefabRole.EnemyAzureMinigunTurret, ArtPassAssetTargetPriority.High, true, "Static blue ion minigun turret with twin-barrel tracking silhouette and cyan emission read.", Scale("0.94m wide", "0.78m tall"));
            ...
            yield return Target("ranged_weapon", "Ranged Weapon Pickup", "Equipment", PresentationPrefabRole.WeaponRanged, ArtPassAssetTargetPriority.High, false, "Generic visual wrapper for pistols/bolts until per-weapon art exists.", Scale("0.6m wide", "pickup-safe"));
            ...
            yield return Target("corrupted_chest", "Corrupted Chest", "Chests", PresentationPrefabRole.ChestCorrupted, ArtPassAssetTargetPriority.High, false, "Rare optional-risk chest with dark danger tint and unmistakable corrupted silhouette.", Scale("0.9m wide", "0.6m tall"));
