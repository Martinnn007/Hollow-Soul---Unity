...
{
    public static class DefaultEquipmentMeshyValidationRunner
    {
        private const string EditModeResultsPath = "output/reports/default-equipment-meshy-editmode-results.xml";
        private const string FocusedEditModeFilter =
        ...
        public static void RunEditModeTestsBatch()
        {
            ...
            Debug.Log(
                $"Default Meshy equipment EditMode tests completed: {result.passCount}/{result.totalCount} passed, " +
