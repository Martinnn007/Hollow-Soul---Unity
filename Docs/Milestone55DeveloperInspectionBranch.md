...
- `F10` opens the debug spawn menu in editor/development gameplay routes. Menu buttons change group/entity, spawn in front of the player, and toggle live/frozen mode.
